...
- (void)getAllEffectItems {
    ...
    NSArray *titles = @[@[@"闪屏", @"人鱼滤镜", @"爱心泡泡", @"大雨", @"轻颤", @"炫彩", @"撒金粉", @"飘花瓣", @"迷幻烟雾", @"爱心光斑", @"蒸汽波", @"彩虹光斑", @"下雨", @"下雪", @"黑白电影", @"波纹", @"蝴蝶", @"流光", @"星光", @"羽毛", @"花火", @"灵魂出窍", @"抖动", @"幻觉", @"迷离", @"窗格", @"摇摆", @"斑驳", @"老电视", @"毛刺", @"缩放", @"闪白", @"霓虹", @"70s", @"X-Signal"], @[@"孙悟空", @"王妃", @"玫瑰眼妆", @"浓妆女王", @"飘落小猪猪", @"贴纸妆", @"飘落樱花"], @[@"模糊分屏", @"黑白三屏", @"两屏", @"三屏", @"四屏", @"六屏", @"九屏"], @[@"光斑模糊变清晰", @"开场", @"缩放转场", @"模糊变清晰", @"倒计时", @"电视开机", @"电视关机", @"横滑", @"卷动", @"横线", @"竖线", @"旋转", @"圆环"], @[@"时光倒流", @"反复", @"慢动作"]];
